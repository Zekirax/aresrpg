...
/** @typedef {typeof initial_world} InitialWorld */
...
function create_world() {
  ...
  /**
   * @template U
   * @typedef {U extends (...args: any) => any ? ReturnType<U> : never} ReturnTypeUnion
   */
  ...
  /** @type {UnionToIntersection<ReturnTypeUnion<typeof functions>> & InitialWorld} */
  const world = /** @type {any} */ functions.reduce(
    (world, fn) => fn(world),
    initial_world
  )
...
/**
 * @typedef {Readonly<ReturnType<typeof create_world>>} World
 */
